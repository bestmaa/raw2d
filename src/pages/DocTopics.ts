...
import { betaInstallTopics } from "./DocBetaInstallTopics";
...
import { reactBetaTopics } from "./DocReactBetaTopics";
...
import { studioDemoTopics } from "./DocStudioDemoTopics";
...
import { webGLCompletionTopics } from "./DocWebGLCompletionTopics";
import { webGLContextTopics } from "./DocWebGLContextTopics";
import { webGLDecisionTopics } from "./DocWebGLDecisionTopics";
...
export const docGroups: readonly DocGroup[] = [
  ...
  },
  {
    ...
    topics: [...reactBetaTopics, ...reactTopics, ...reactReconcilerTopics, ...reactReadinessTopics]
  }
];
