    ...
    sections: [
      {
        ...
        code: `curl -I https://cdn.jsdelivr.net/npm/raw2d@1.21.0/dist/raw2d.js
curl -I https://cdn.jsdelivr.net/npm/raw2d@1.21.0/dist/raw2d.umd.cjs`
      },
      {
        title: "Latest URL",
...
curl -I https://cdn.jsdelivr.net/npm/raw2d/dist/raw2d.umd.cjs`
      },
      {
        ...
        code: `import { Scene, Camera2D, CanvasRenderer } from "https://cdn.jsdelivr.net/npm/raw2d@1.21.0/dist/raw2d.js";
