...
- T011 | Version: v0.3.10 | Status: pending | Goal: Add deprecation note helper for future breaking changes. | Verify: typecheck and docs. | Commit: `Add deprecation note helper`
...
- T013 | Version: v0.4.0 | Status: pending | Goal: Rebuild docs navigation into grouped learning paths. | Verify: browser nav and search. | Commit: `Group docs navigation paths`
...
- T027 | Version: v0.5.0 | Status: pending | Goal: Document `Scene -> RenderList -> Batcher -> Buffer -> Shader -> DrawCall`. | Verify: docs in browser. | Commit: `Document WebGL pipeline`
- T028 | Version: v0.5.1 | Status: pending | Goal: Add render list docs and practical example. | Verify: browser example. | Commit: `Document render lists`
...
- T041 | Version: v0.6.0 | Status: pending | Goal: Create benchmark page route. | Verify: route loads in browser. | Commit: `Add benchmark page route`
...
- T046 | Version: v0.6.5 | Status: pending | Goal: Add FPS, frame time, draw call, and texture bind display. | Verify: live stats update. | Commit: `Add benchmark stats`
...
- T076 | Version: v0.8.8 | Status: pending | Goal: Add plugin command to run docs QA. | Verify: command output. | Commit: `Add Raw2D docs QA command`
...
- T085 | Version: v0.9.4 | Status: pending | Goal: Add JSX primitives for Rect, Circle, Line, Sprite, and Text2D. | Verify: React example. | Commit: `Add Raw2D JSX primitives`
...
- T089 | Version: v0.10.0 | Status: pending | Goal: Audit every docs route and example route manually. | Verify: browser checklist. | Commit: `Audit docs and examples`
...
- T096 | Version: v0.10.7 | Status: pending | Goal: Add docs visual QA checklist for WebGL examples. | Verify: browser checklist. | Commit: `Add WebGL docs QA checklist`
- T097 | Version: v0.10.8 | Status: pending | Goal: Add docs visual QA checklist for interaction examples. | Verify: browser checklist. | Commit: `Add interaction docs QA checklist`
