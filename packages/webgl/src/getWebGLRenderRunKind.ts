import { Arc, Circle, Ellipse, Line, Polygon, Polyline, Rect, ShapePath, getRendererSupportMatrix, type Object2D } from "raw2d-core";
...
export function isWebGLShape(object: Object2D): object is Arc | Rect | Circle | Ellipse | Line | Polyline | Polygon | ShapePath {
  return (
    ...
    (object instanceof ShapePath && webGLSupportedKinds.has("ShapePath"))
  );
}
