import { Circle, Ellipse, Line, Polygon, Polyline, Rect } from "raw2d-core";
...
export function getWebGLMaterialKey(item: WebGLShapeItem): string {
  ...
  if (object instanceof Rect || object instanceof Circle || object instanceof Ellipse || object instanceof Polygon) {
    return serializeMaterialKey({
      pass: "fill",
