...
- T270 | Version: v1.18.3 | Status: completed | Goal: Add multi-select selection bounds and group move for selected objects. | Verify: shift-select, drag group, delete group, and layer panel tests. | Commit: `Add Studio multi select`
- T271 | Version: v1.18.4 | Status: completed | Goal: Add visual regression coverage for resize handles crossing all four corners. | Verify: browser screenshot or pixel check. | Commit: `Test Studio resize visuals`
- T272 | Version: v1.18.5 | Status: completed | Goal: Phase 26 release and publish. | Verify: CI, npm latest, Cloudflare docs, transform tool workflows. | Commit: `Release Studio transform tools phase`
...
- T278 | Version: v1.19.5 | Status: completed | Goal: Phase 27 release and publish. | Verify: CI, npm latest, Cloudflare docs, Studio import/export workflow. | Commit: `Release Studio import export phase`
...
- T280 | Version: v1.20.1 | Status: completed | Goal: Add Canvas effect application for opacity, shadow, blur, and grayscale using explicit renderer hooks. | Verify: Canvas renderer tests and visual route check. | Commit: `Add Canvas effects`
- T281 | Version: v1.20.2 | Status: completed | Goal: Add WebGL effect support plan and minimal shader-pass boundary without coupling effects into core. | Verify: WebGL package tests and docs boundary checks. | Commit: `Add WebGL effects boundary`
- T282 | Version: v1.20.3 | Status: completed | Goal: Add effects examples showing Canvas-first behavior and WebGL support limits. | Verify: examples tests and browser route check. | Commit: `Add effects examples`
- T283 | Version: v1.20.4 | Status: completed | Goal: Document effects package APIs, non-goals, and renderer separation rules. | Verify: docs route and package README checks. | Commit: `Document effects package`
- T284 | Version: v1.20.5 | Status: completed | Goal: Phase 28 release and publish. | Verify: CI, npm latest, Cloudflare docs, effects examples. | Commit: `Release effects foundation phase`
...
- T296 | Version: v1.22.5 | Status: completed | Goal: Phase 30 release and publish. | Verify: CI, npm latest, Cloudflare docs, React consumer installs. | Commit: `Release React Fiber phase`

## Phase 31: MCP Studio Automation

- T297 | Version: v1.23.0 | Status: completed | Goal: Add MCP scene edit plans for Studio-safe create, update, delete, reorder, and asset-reference operations. | Verify: MCP unit tests for deterministic plans. | Commit: `Add MCP Studio edit plans`
...
- T302 | Version: v1.24.0 | Status: completed | Goal: Add grouping and ungrouping in Studio using `Group2D` semantics without hiding scene hierarchy. | Verify: unit and browser group edit tests. | Commit: `Add Studio grouping`
...
- T307 | Version: v1.24.5 | Status: blocked | Goal: Phase 32 release and publish. | Verify: CI, npm latest, Cloudflare docs, Studio advanced editing workflow. | Commit: `Release Studio advanced editing phase`
...
- T308 | Version: v1.25.0 | Status: completed | Goal: Freeze public APIs across all packages and add migration notes for aliases or deprecated names. | Verify: public surface audit and type tests. | Commit: `Freeze Raw2D public API`
- T309 | Version: v1.25.1 | Status: completed | Goal: Add full renderer parity browser matrix across Canvas and WebGL examples. | Verify: browser and visual regression suite. | Commit: `Add renderer parity matrix`
...
- T313 | Version: v1.25.5 | Status: blocked | Goal: Phase 33 release candidate and publish. | Verify: CI, npm latest, Cloudflare docs, CDN pinned URLs, post-release audit. | Commit: `Release Raw2D v1 candidate`
  - Blocked: pushed `main` and tag `v1.25.5`; CI, Plugin, and Cloudflare Workers passed, and Publish workflow passed Test, Pack check, Package readiness audit, Consumer install smoke, and CDN pinned dry run. Publish failed only at the npm publish step, and npm latest remains `1.16.6`.
