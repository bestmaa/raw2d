...
WebGL currently focuses on batched shapes, ShapePath strokes, sprites, atlas textures, and cached static runs. Canvas remains the fallback for ShapePath fill and exact path behavior.
